...
<html lang="en">
	<head>
		...
		<!-- Ketiga meta tag di atas *harus* ditempatkan pertama dalam tag head; konten head lainnya harus ditempatkan *setelah* tag-tag ini -->
	...
	<!-- Penyokong HTML5 dan Respond.js untuk mendukung IE8 pada elemen HTML5 dan media queries -->
		<!--[if lt IE 9]>
    ...
    <style>
        #navigation {
          background:#000080;  /* fallback atau alternatif untuk browser lama */
        ...
        #bottom-footer {
            background: #000080;  /* fallback/ untuk browser lama */
            background: -webkit-linear-gradient(to right, #348AC7, #000080);  /* Chrome 10-25, Safari 5.1-6 */
            background: linear-gradient(to right, #348AC7, #000080); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
